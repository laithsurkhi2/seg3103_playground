...
public class DateNextDateOkTest
{
  ...
  private Date myday;
  private Date expectday;

  public DateNextDateOkTest(
    int myyear, int mymonth, int myday,
    int expectyear, int expectmonth, int expectday)
  {
    this.myday = new Date(myyear, mymonth, myday);
    this.expectday = new Date(expectyear, expectmonth, expectday);
  }
  ...
  {
    Date actday = myday.nextDate();
    Assert.assertEquals(expectday, actday);
  }
